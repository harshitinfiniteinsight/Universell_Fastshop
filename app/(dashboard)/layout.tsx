...
function DashboardLayoutInner({
  ...
  const mainNavItems: NavItem[] = [
    ...
    { icon: ShoppingCart, label: "Sales", href: "/sales", external: false },
    {
      ...
      isAccordion: true,
      children: [
        { icon: Sparkles, label: "Landing Page", href: "/ai-web-builder/landing-page" },
        { icon: Globe, label: "Website Builder", href: "/ai-web-builder/website-builder" },
        { icon: ShoppingBag, label: "E-Commerce Fastshop", href: "/ai-web-builder/ecommerce-fastshop" },
      ],
    },

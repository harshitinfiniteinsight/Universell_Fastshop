...
export const MODULES: ModuleDefinition[] = [
  ...
  },
  {
    ...
    shortDescription: "Create, send, and manage digital agreements with e-signatures and audit trails.",
    fullDescription:
      "Streamline your contract management with digital agreements. Create agreement templates, customize terms and conditions, send agreements via email or SMS, capture digital signatures securely, maintain complete audit trails, and manage document storage. Perfect for service providers, professionals, and B2B sellers who need legal documentation.",
    icon: "FileSignature",
    phase: 2,
    prerequisites: ["crm"],
    setupSteps: [
      {
        id: "agr-1",
        title: "Add your first customer",
        description: "You need a customer to send agreements to. Set them up in CRM first.",
        prerequisiteModuleId: "crm",
        completed: false,
      },
      {
        id: "agr-2",
        title: "Create an agreement template",
        description: "Design your first agreement template with your business terms and conditions.",
        completed: false,
      },
      {
        id: "agr-3",
        title: "Configure signature capture",
        description: "Set up how customers will sign (digital, drawing, typed) and authentication level.",
        completed: false,
      },
      {
        id: "agr-4",
        title: "Send your first agreement",
        description: "Select a customer and send them an agreement via email or SMS.",
        completed: false,
      },
      {
        id: "agr-5",
        title: "Track agreement status",
        description: "Monitor sent agreements, view signatures, and access audit logs.",
        completed: false,
      },
    ],
    features: [
      "Customizable agreement templates",
      "Digital signature capture (stylus, mouse, typed)",
      "Email and SMS delivery",
      "Signature verification and audit trail",
      "Document storage and retrieval",
      "Multi-page agreement support",
      "Timestamp and authentication logging",
      "Customer signature history",
      "Recurring agreement management",
      "Integration with invoices and orders",
    ],
    whyItMatters: {
      retail: "Protect your business with service agreements, warranty terms, and return policies.",
      restaurant: "Document catering agreements, delivery terms, and liability waivers.",
      salon: "Collect client release forms, consent forms, and service agreements digitally.",
      health: "Manage waivers, consent forms, and HIPAA-compliant documentation.",
      professional: "Essential for contracts, service agreements, and client terms.",
      ecommerce: "Validate terms acceptance and manage customer agreements at scale.",
      hospitality: "Secure booking agreements and liability waivers from guests.",
      other: "Legal protection with digital proof of agreement.",
      default: "Digital agreements provide legal protection and streamline your workflows.",
    },
  },
  {
    id: "appointments",
    name: "Appointments & Booking",
    shortDescription: "Schedule services, manage availability, and allow customers to self-book appointments.",
    fullDescription:
      "Give customers the ability to book appointments directly. Set your availability by day and time, create bookable services with duration and pricing, send automated reminders via email or SMS, manage no-shows and cancellations, and view your full schedule. Integrates with your calendar and customer profiles to streamline scheduling.",
    icon: "Calendar",
    phase: 2,
    prerequisites: ["crm"],
    setupSteps: [
      {
        id: "apt-1",
        title: "Set up bookable services",
        description: "Define services customers can book (haircut, consultation, massage, etc.) with duration and price.",
        completed: false,
      },
      {
        id: "apt-2",
        title: "Configure your availability",
        description: "Set your working hours by day of week and block off breaks or busy times.",
        completed: false,
      },
      {
        id: "apt-3",
        title: "Create a booking page",
        description: "Generate a public booking link customers can use to self-book appointments.",
        completed: false,
      },
      {
        id: "apt-4",
        title: "Set up appointment reminders",
        description: "Enable automated SMS or email reminders before appointments.",
        completed: false,
      },
      {
        id: "apt-5",
        title: "Test a booking",
        description: "Create a test appointment to ensure the booking flow works correctly.",
        completed: false,
      },
    ],
    features: [
      "Service creation with duration and pricing",
      "Availability scheduling by time slot",
      "Online booking widget for your website",
      "Customer self-booking (no staff time needed)",
    ...
    whyItMatters: {
      retail: "Enable same-day or scheduled services; let customers book alteration appointments.",
      restaurant: "Manage reservations, private events, and catering bookings.",
      salon: "Reduce no-shows and administrative work with online booking.",
      health: "Streamline class registration, personal training bookings, and consultations.",
      professional: "Let clients book consultations, meetings, and appointments without back-and-forth.",
      ecommerce: "Offer services like consultations, installations, or training sessions.",
      hospitality: "Manage bookings for tours, activities, wellness sessions, and special experiences.",
      other: "Reduce scheduling friction and increase appointment compliance.",
      default: "Online booking increases conversion and reduces administrative overhead.",
    },
  },
  {
    id: "estimates",
    name: "Job Estimates",
    shortDescription: "Create professional estimates, track acceptance, and convert them to orders or invoices.",
    fullDescription:
      "Generate professional estimates and quotes for your customers. Build estimates from your inventory with real pricing, send via email or SMS, track estimate acceptance and rejection, set expiration dates, and seamlessly convert accepted estimates into orders or invoices. Perfect for contractors, designers, consultants, and service providers.",
    icon: "FileText",
    phase: 2,
    prerequisites: ["crm"],
    setupSteps: [
      {
        id: "est-1",
        title: "Add your first customer",
        description: "You need a customer for estimates. Set them up in CRM first.",
        prerequisiteModuleId: "crm",
        completed: false,
      },
      {
        id: "est-2",
        title: "Create an estimate template",
        description: "Design your estimate template with your business name, logo, and default terms.",
        completed: false,
      },
      {
        id: "est-3",
        title: "Add line items",
        description: "Create reusable line items (labor, materials, services) with pricing.",
        completed: false,
      },
      {
        id: "est-4",
        title: "Generate your first estimate",
        description: "Build an estimate for a customer and set an expiration date.",
        completed: false,
      },
      {
        id: "est-5",
        title: "Send and track",
        description: "Send the estimate via email and monitor acceptance/rejection status.",
        completed: false,
      },
    ],
    features: [
      "Professional estimate templates",
      "Line item creation with pricing",
      "Inventory integration for accurate pricing",
      "Tax and discount calculations",
      "Expiration date management",
      "Email delivery with tracking",
      "Customer acceptance/rejection tracking",
      "Convert estimate to order or invoice",
      "Revision and versioning",
      "Reusable estimate templates by project type",
    ],
    whyItMatters: {
      retail: "Quote customers on custom projects, alterations, or bulk orders.",
      restaurant: "Provide catering or event quotes with transparent pricing.",
      salon: "Quote bridal packages, extensive treatments, or group bookings.",
      health: "Estimate costs for training packages, memberships, or wellness programs.",
      professional: "Essential for consultants, contractors, and service providers to quote work.",
      ecommerce: "Enable wholesale quotes, bulk pricing, and custom project estimates.",
      hospitality: "Quote events, packages, and custom experiences with professional pricing.",
      other: "Professional estimates build customer confidence and reduce quote disputes.",
      default: "Clear, professional estimates close more deals and reduce scope creep.",
    },
  },
];
